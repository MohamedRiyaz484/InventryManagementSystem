...
public class UserController {
    ...
    // ✅ Show registration page only (actual registration handled by OtpController)
    ...
    // ❌ This method breaks OTP flow, better to disable/comment it
    ...
    @PostMapping("/dologin")
    public void doLogin(@RequestParam String email,
